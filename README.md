...
[**./src/IReferralProgram.sol**](./src/IReferralProgram.sol)
...
The core logic of this interface is implemented by `ReferralProgram`. The `ReferralProgram` is constructed with an immutable reference to the `ETHRegistry` and seeded with its commission treasury. Its fallback handler is payable, allowing anyone to contribute more funds to the referral program if they'd like to keep it running. The `ReferralProgram` is `Ownable` and its owner (the deployer) can optionally close the program and withdraw any un-rewarded funds.

[**./src/ReferralProgram.sol**](./src/ReferralProgram.sol)
...
[**./src/examples/PercentReferralProgram.sol**](./src/examples/PercentReferralProgram.sol)
...
[**./src/examples/LoyaltyReferralProgram.sol**](./src/examples/LoyaltyReferralProgram.sol)
...
[**./src/examples/AllowlistReferralProgram.sol**](./src/examples/AllowlistReferralProgram.sol)
